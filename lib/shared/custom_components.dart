...
// Important: Remove any padding from the ListView.
          ...
          children: [
            UserAccountsDrawerHeader(
              ...
              accountName: Text(cAppTitle,style: TextStyle(color: bgcolor,fontWeight: FontWeight.bold),),
            ...
            //     )
            //   },
            //   subtitle: Text('Manage supply chain',style: TextStyle(color: Colors.white),),
            ...
            ListTile(
              ...
              subtitle: Text('Manage Reports',style: TextStyle(color: Colors.white),),
              trailing: Icon(Icons.more_vert),
              isThreeLine: true,
            ),
            ListTile(
          ...
          children: [
            ...
            Container(
              ...
              child: ListTile(
                ...
                subtitle: Text('Upcoming appointments',style: TextStyle(color: Colors.white),),
              ),
            ),
            ListTile(
              ...
              subtitle: Text('Manage personal data & info.',style: TextStyle(color: Colors.white),),
              trailing: Icon(Icons.more_vert),
              isThreeLine: true,
            ),
            ListTile(
              ...
              subtitle: Text('OPD, IPD, Rx, LAB, COVID Vaccine records.',style: TextStyle(color: Colors.white),),
              trailing: Icon(Icons.more_vert),
              isThreeLine: true,
            ),
            // ListTile(
