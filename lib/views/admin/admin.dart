...
class AdminState extends State<Admin> {
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      ...
      appBar: AppBar(title: const Text(cAdmin,style: TextStyle(color: bgcolor),),backgroundColor: butcolor,iconTheme: IconThemeData(color: bgcolor),),
  ...
  Widget loginPage(AuthBloc authBloc) {
    return Column(
      children: [
        ...
        ElevatedButton(
          child: Text('Click here to go to Login page',style: TextStyle(color: bgcolor),),
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          return new ListView(
            children: snapshot.data.docs.map((DocumentSnapshot document) {
              return new ListTile(
                title: new Text(document.get('name'),style: TextStyle(color: Colors.white),),
                subtitle: Column(
                  children: [
                    const Divider(
                      color: Colors.white,
                    ...
                    Row(
                      children: [
                        ...
                        new Text(document.get('email'),style: TextStyle(color: Colors.white),)
                      ],
                    ),
                    Row(
                      children: [
                    ...
                    Row(
                      children: [
                        Row(
                          children: [
                            new Text("Author: ",style: TextStyle(color: Colors.white),),
                            new Text(document.get('author'),style: TextStyle(color: Colors.white),),
                          ],
                        )
                      ],
                    ),
                    Row(
                      children: [
                        Row(
                          children: [
                            new Text("Role: ",style: TextStyle(color: Colors.white),),
                            new Text(document.get('role') == null
                                ? "None assigned"
                                : document.get('role'),style: TextStyle(color: Colors.white),),
                          ],
                        )
                      ],
                    ),
                    Row(
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            _deleteUser(document.get('author'));
                          },
                        )
                      ],
                    )
