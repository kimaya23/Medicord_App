...
class LABState extends State<LAB> {
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      ...
      appBar: AppBar(title: const Text(cPathologysTitle,style: TextStyle(color: bgcolor),),backgroundColor: butcolor,iconTheme: IconThemeData(color: bgcolor),),
          ...
          return new ListView(
            children: snapshot.data.docs.map((DocumentSnapshot document) {
              return new ListTile(
                ...
                subtitle: Column(
                  children: [
                    new Text(document.get('rxDate').toDate().toString(),style: TextStyle(color: Colors.white),),
                    const Divider(
                      color: Colors.black,
                      height: 5,
                      thickness: 2,
          ...
          return new ListView(
            children: snapshot.data.docs.map((DocumentSnapshot document) {
              return new ListTile(
                ...
                subtitle: Column(
                  children: [
                    new Text(document.get('labDate').toDate().toString(),style: TextStyle(color: Colors.white),),
                    const Divider(
                      color: Colors.white,
                      height: 5,
                      thickness: 2,
