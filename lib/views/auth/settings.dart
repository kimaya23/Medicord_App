...
class SettingsState extends State<Settings> {
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      ...
      appBar: AppBar(title: const Text(cSettingsTitle,style: TextStyle(color: bgcolor),),backgroundColor: butcolor,iconTheme: IconThemeData(color: bgcolor),),
      drawer: Drawer(
          child: isAdmin
  ...
  Widget settings(context,AuthBloc authBloc) {
    return Form(
      key: _formKey,
