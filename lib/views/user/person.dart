...
class PersonState extends State<Person> {
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      ...
      appBar: AppBar(title: const Text(cPerson,style: TextStyle(color: bgcolor),),backgroundColor: butcolor,iconTheme: IconThemeData(color: bgcolor),),
      drawer: Drawer(
              ...
              children: <Widget>[
                ...
                Container(
                    ...
                    child: TextFormField(
                      ...
                      validator: evalName,
                      decoration: InputDecoration(
                        icon: Icon(Icons.desktop_windows,color: Colors.white,),
                        border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(16.0)),
                        hintText: 'Occupation',
                ...
                Container(
                    ...
                    child: TextFormField(
                      ...
                      validator: evalName,
                      decoration: InputDecoration(
                        icon: Icon(Icons.gps_off,color: Colors.white,),
                        border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(16.0)),
                        hintText: 'Zip Code',
                        labelText: 'zipcode *',
                ...
                Container(
                    ...
                    child: TextFormField(
                      ...
                      validator: evalChar,
                      decoration: InputDecoration(
                        icon: Icon(Icons.family_restroom_rounded,color: Colors.white,),
                        border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(16.0)),
                        hintText: 'Siblings',
                        labelText: 'Siblings *',
